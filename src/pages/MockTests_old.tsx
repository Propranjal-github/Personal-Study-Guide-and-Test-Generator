...
//   const handleCreateCustomTest = (data: any) => {
//     console.log("Creating custom test with:", data);
//     // In a real app, this would send the data to an API and redirect to the test page
...
//                                       <Checkbox id={topic.toLowerCase().replace(' ', '-')} />
//                                       <label htmlFor={topic.toLowerCase().replace(' ', '-')} className="text-sm">
//                                         {topic}
//                                       </label>
//                                     </div>
//                                   ))}
...
//                     <Button type="submit" className="w-full">Start Custom Test</Button>
//                   </form>
//                 </Form>
//               </div>
//             )}
